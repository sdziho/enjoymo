...
(function($) {
    ...
    var $filtriraj = $('.mreza').isotope({
        // options
        itemSelector: '.clanak',
        layoutMode: 'fitRows'
    });
    var $choice = $('.opcije').isotope({
        // options
        itemSelector: '.clanak',
        layoutMode: 'fitRows'
    });
    ...
    $(document).ready(function() {
        var filterValue = ".one";
        if(window.location.href.substr(-3)=="adr") filterValue = ".adr";
        else if(window.location.href.substr(-3)=="rel") filterValue = ".rel";
    ...
    $('.filters-button-group').on( 'click', 'a', function() {
        var filterValue = $(this).attr('data-filter');
        $filtriraj.isotope({ filter: filterValue });
    });
    $('.filters-button-group').on( 'click', 'a', function() {
        var filterValue = $(this).attr('data-filter');
        $choice.isotope({ filter: filterValue });
